import { createHash, createDecipheriv, createCipheriv, randomBytes } from "crypto"; // Node.js crypto (used for the key generation)
import * as CryptoJS from "crypto-js"; // crypto-js for frontend
